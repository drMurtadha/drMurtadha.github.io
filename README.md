...
All 13 public routes are now native Astro pages. Publication, supervision and teaching datasets are generated deterministically from the approved current-page snapshots; the original sanitised records remain available as migration evidence and are not used as runtime page templates. One route, `/student-development/`, is native content supplied directly by the owner rather than a WordPress import — see [ASSET_REGISTER.md](ASSET_REGISTER.md).
